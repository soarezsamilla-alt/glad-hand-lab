...
.pr .bonus-cover img{display:block;margin:0 auto;max-width:70%;max-height:160px;width:auto;height:auto;aspect-ratio:auto;object-fit:contain;padding:18px 0}
