...
<header class="hero">
  ...
  <h1>
    +150 Proyectos de Propiedades Rurales Productivas
    <span class="sub-line">que transforman tu tierra parada en una fuente de ingresos mensuales</span>
  </h1>
  <p class="hero-text">La biblioteca más completa de proyectos rurales de América Latina: <b>+150 planos profesionales</b> con medidas reales, divisiones estratégicas y layouts listos para ejecutar.</p>
...
<section class="sec sec--white">
  <div class="wrap reveal">
    ...
    <p class="sec-sub" style="margin-top:10px;font-size:.9rem"><b>Nota:</b> los +150 proyectos siguen el mismo estándar editorial premium.</p>
  </div>
</section>
...
<section class="sec sec--navy">
  <div class="wrap reveal">
    ...
    <div class="ba" id="ba">
      <img src="${comparacaoSplit.url}" alt="Comparación: sin los proyectos vs con +150 proyectos" loading="lazy" width="1024" height="576">
      ...
      <div class="ba-overlay">
        ...
        <span class="ba-badge good"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#1f8a36" stroke-width="2.6"><circle cx="12" cy="12" r="10"/><path d="m8 12 3 3 5-6"/></svg> Con +150 Proyectos</span>
      </div>
    </div>
    <div class="cmp-wrap">
      <div class="cmp-card">
  ...
  <div class="reveal">
    ...
    <div class="kit-card">
      <div class="kit-mock">
        ...
        <img src="https://www.image2url.com/r2/default/images/1782948795231-bec3f465-9115-4564-9f83-2d9405d6dec1.webp" alt="Kit +150 Proyectos">
      </div>
      <div>
        <span class="item-tag">ÍTEM 01</span>
        <h2>+150 Proyectos de Propiedades Rurales Productivas</h2>
  ...
  <div class="wrap reveal">
    ...
    <div class="price-single" style="margin-bottom:28px">
      <div class="price-card price-card--basic">
        ...
        <ul class="price-list">
          <li><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.8"><path d="M20 6 9 17l-5-5"/></svg> +150 proyectos completos</li>
    ...
    <div class="instagram-card">
      <div class="instagram-profile">
        ...
        <div class="instagram-badges">
          ...
          <span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.6"><path d="M20 6 9 17l-5-5"/></svg> +150 proyectos profesionales de fincas</span>
        </div>
      </div>
      <div class="instagram-stats">
        <div><b>+150</b><span>Proyectos</span></div>
...
<section class="sec sec--white">
  <div class="wrap reveal">
    ...
    <div class="faq-list" id="faq">
      ...
      <div class="faq-item"><button class="faq-q">¿Qué diferencia hay con contratar un agrónomo? <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2"><path d="m6 9 6 6 6-6"/></svg></button><div class="faq-a"><p>Un proyecto a la medida cuesta miles. Aquí recibes +150 proyectos por un precio único.</p></div></div>
